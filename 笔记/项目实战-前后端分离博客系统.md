...
<mapper namespace="com.sangeng.com.sangeng.mapper.MenuMapper">
...
<?xml version="1.0" encoding="UTF-8" ?>
<!DOCTYPE mapper PUBLIC "-//mybatis.org//DTD Mapper 3.0//EN" "http://mybatis.org/dtd/mybatis-3-mapper.dtd" >
<mapper namespace="com.sangeng.com.sangeng.mapper.RoleMapper">
...
~~~~xml
 <select id="selectAllRouterMenu" resultType="com.sangeng.domain.com.sangeng.domain.entity.Menu">
        SELECT
    ...
    <select id="selectRouterMenuTreeByUserId" resultType="com.sangeng.domain.com.sangeng.domain.entity.Menu">
        SELECT
          DISTINCT m.id, m.parent_id, m.menu_name, m.path, m.component, m.visible, m.status, IFNULL(m.perms,'') AS perms, m.is_frame,  m.menu_type, m.icon, m.order_num, m.create_time
        FROM
            `sys_user_role` ur
